...
function showMantraDetails(mantraContainer, showMobilePane = true) {
  ...
  if (window.innerWidth <= 800 && showMobilePane) {
    commentaryPane.classList.add("active");
...
function addEventListeners() {
  ...
  mobileNavToggle.addEventListener("click", () => {
    navigatorPane.classList.add("active");
    mobileOverlay.classList.add("active");
  });

  mobileNavClose.addEventListener("click", closeOverlays);
  mobileCommentaryClose.addEventListener("click", closeOverlays);
  mobileOverlay.addEventListener("click", closeOverlays);
}
